...
import { BoardConfig, DoraSnapshot, CycleTimeSnapshot, SupportSnapshot } from '../database/entities/index.js';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([BoardConfig, DoraSnapshot, CycleTimeSnapshot, SupportSnapshot]),
