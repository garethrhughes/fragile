...
const FIXTURE_BOARDS = [
  { boardId: 'ACC', boardType: 'scrum', doneStatusNames: [], failureIssueTypes: [], failureLinkTypes: [], failureLabels: [], incidentIssueTypes: [], recoveryStatusNames: [], incidentLabels: [], backlogStatusIds: [], dataStartDate: null, inProgressStatusNames: [], cancelledStatusNames: [], roadmapLinkTypes: [], supportLabels: [], supportLinkType: null, triageBoardKey: null, supportEpics: [] },
