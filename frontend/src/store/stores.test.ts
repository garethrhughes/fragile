...
const FIXTURE_BOARDS = [
  { boardId: 'ACC', boardType: 'scrum', doneStatusNames: [], failureIssueTypes: [], failureLinkTypes: [], failureLabels: [], incidentIssueTypes: [], recoveryStatusNames: [], incidentLabels: [], backlogStatusIds: [], boardEntryStatuses: null, dataStartDate: null, inProgressStatusNames: [], cancelledStatusNames: [], roadmapLinkTypes: [], supportLabels: [], supportLinkTypes: [], triageBoardKey: null, supportEpics: [] },
