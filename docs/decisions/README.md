...
| [0070](0070-support-load-context-metric-and-trend-sparklines.md) | Support Load as a context metric (per-team % + count + trend, org = mean of team %s), excluded from health score; Recharts trend sparklines; Health Check section separation | Accepted | 2026-07-28 |
